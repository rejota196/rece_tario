...
const EditNestedLocation = () => {
  ...
  useEffect(() => {
    axiosInstance.get(`/reciperover/recipes/${recipe_pk}/locations/${id}/`)
      .then(response => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axiosInstance.put(`/reciperover/recipes/${recipe_pk}/locations/${id}/`, { name, address });
